...
- The "Claude 订阅" card in the Connections page reads `~/.claude/.credentials.json` (inside the static allowlist) to detect OAuth login status. It does not access the keychain.
